...
postgres_db="agentharness_${slug}_${offset}"
postgres_port=5432
...
POSTGRES_USER=agentharness
POSTGRES_PASSWORD=agentharness
POSTGRES_PORT=${postgres_port}
DATABASE_URL=postgres://agentharness:agentharness@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
AGENTHARNESS_SERVER_URL=ws://localhost:${backend_port}/ws
AGENTHARNESS_APP_URL=${frontend_origin}
