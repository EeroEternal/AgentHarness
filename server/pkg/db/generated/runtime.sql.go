...
const updateAgentRuntimeMetadata = `-- name: UpdateAgentRuntimeMetadata :one
UPDATE agent_runtime
...
type UpdateAgentRuntimeMetadataParams struct {
	Metadata    []byte      `json:"metadata"`
	ID          pgtype.UUID `json:"id"`
	WorkspaceID pgtype.UUID `json:"workspace_id"`
}

func (q *Queries) UpdateAgentRuntimeMetadata(ctx context.Context, arg UpdateAgentRuntimeMetadataParams) (AgentRuntime, error) {
	row := q.db.QueryRow(ctx, updateAgentRuntimeMetadata, arg.Metadata, arg.ID, arg.WorkspaceID)
	var i AgentRuntime
	err := row.Scan(
		&i.ID,
		&i.WorkspaceID,
